...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                R.layout.jrcy_header, null);

        mHeaderRefreshTimeContainer
                = (LinearLayout) mContainer.findViewById(R.id.rcy_header_state);
        ...
        mArrowImageView = (ImageView)findViewById(R.id.rcy_header_arrow);
        mStatusTextView = (TextView)findViewById(R.id.ic_header_tip);

        //init the progress view
        mProgressBar = (SimpleViewSwitcher)findViewById(R.id.rcy_header_progress);
        ...
        mHeaderTimeView = (TextView)findViewById(R.id.rcy_header_state_update_time);
    ...
    public void setState(int state) {
        ...
        switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.j_list_header_hint_normal);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    ...
                    setRefreshTimeVisible(true);
                    mStatusTextView.setText(R.string.j_list_header_hint_release);
                }
                break;
            case STATE_REFRESHING:
                setRefreshTimeVisible(false);
                mStatusTextView.setText(R.string.j_refreshing);
                break;
            case STATE_DONE:
                setRefreshTimeVisible(false);
                mStatusTextView.setText(R.string.j_refresh_done);
                break;
            default:
        }
